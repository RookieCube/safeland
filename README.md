...
[![Android CI](https://github.com/RookieCube/safeland/actions/workflows/android-build.yml/badge.svg)](https://github.com/RookieCube/safeland/actions/workflows/android-build.yml)
...
```bash
# 克隆仓库
git clone https://github.com/RookieCube/safeland.git
cd SafeLand
